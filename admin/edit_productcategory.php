...
echo $_GET['id'];
require 'connect.php';
$qry="SELECT * FROM product_cat_tbl WHERE isactive != 2 AND id='".$_GET['id']."'";
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Edit Product Category</h2>
                                </header>
                                <div class="contents">
                                    <a class="togglethis">Toggle</a>
                                    <div class="table-box">
                                        <form action="category_product_process_update.php" method="post">
                                        	<input type='hidden' name="id" value="<?php echo $row['id'] ?>">
                                        <table class="table">
                                            <tbody>
                                                 <tr>
                                                    <td class="col-md-4">Product Category Name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="categoryname" class="form-control" name="name" value="<?php echo $row['category_name'] ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">
