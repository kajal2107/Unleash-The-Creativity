                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Add SubCategory</h2>
                                </header>
                                <div class="contents">
                                    <a class="togglethis">Toggle</a>
                                    <div class="table-box">
                                        <form action="addsubcategory_process.php" method="post">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Select Category</td>
                                                    <td class="col-md-8">
                                                        <?php 
                                                        require 'connect.php';
                                                        $q = "SELECT * FROM category_tbl WHERE isactive=1";
                                                ...
                                                <tr>
                                                    <td class="col-md-4">Sub Category Name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Category name" class="form-control" name="sname"></td>
                                                </tr>
                                                    <td class="col-md-4">
                                                        <button type="submit" class="btn btn-success" name="submit"> Add SubCategory</button></td>
                                                    <td class="col-md-8">
