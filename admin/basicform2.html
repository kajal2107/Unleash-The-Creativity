                    ...
                    <ul class="navi-acc" id="nav2">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="basictables.html">View User</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#pages" class="pages">Manage Category</a>
                            <ul>
                                <li><a href="basicform1.html">Add Category</a></li>
                                <li><a href="basictables1.html">View Category</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#pages" class="pages">Manage Sub Category</a>
                            <ul>
                                <li><a href="basicform2.html">Add Sub Category</a></li>
                                <li><a href="basictables2.html">View Sub Category</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="SubCategoryName:" class="form-control"></td>
                                                </tr>
                                                    <td class="col-md-4">
