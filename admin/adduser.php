                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="Firstname" class="form-control" name="firstname"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Last Name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Last Name:" class="form-control" name="lastname"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Email:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Email:" class="form-control" name="email"></td>
                                                </tr>
                                               <!--  <tr>
                                                ...
                                                --> <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="password" placeholder="Password" class="form-control" name="password"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Comfirm Password:</td>
                                                    <td class="col-md-8"><input type="password" placeholder="Password" class="form-control" name="confirmpassword"></td>
                                                </tr>
                                                    <td class="col-md-4">
