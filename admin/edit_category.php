...
echo $_GET['id'];
require 'connect.php';
$qry="SELECT * FROM category_tbl WHERE isactive != 2 AND id='".$_GET['id']."'";
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        <form action="category_process_update.php" method="post">
                                        	<input type='hidden' name="id" value="<?php echo $row['id'] ?>">
                                        <table class="table">
                                            <tbody>
                                                 <tr>
                                                    <td class="col-md-4">Category Name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="categoryname" class="form-control" name="name" value="<?php echo $row['name'] ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">
