                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Add Product  Category</h2>
                                </header>
                                <div class="contents">
                                    <a class="togglethis">Toggle</a>
                                    <div class="table-box">
                                        <form action="addproductcategory_process.php" method="post">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Category Name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Category name" class="form-control" name="name"></td>
                                                </tr>
                                                    <td class="col-md-4">
                                                        <button class="btn btn-success" name="submit"> Add Category</button></td>
                                                    <td class="col-md-8">
