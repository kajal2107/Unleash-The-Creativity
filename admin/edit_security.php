...
echo $_GET['id'];
require 'connect.php';
$qry="SELECT * FROM security_tbl WHERE isactive != 2 AND id='".$_GET['id']."'";
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        <form action="security_process_update.php" method="post">
                                        	<input type='hidden' name="id" value="<?php echo $row['id'] ?>">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Security Question</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Question" class="form-control" value="<?php echo $row['question'] ?>" name="question"></td>
                                                </tr>
                                                    <td class="col-md-4">
