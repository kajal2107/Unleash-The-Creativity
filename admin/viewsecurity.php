  <?php
require 'connect.php';
$qry="SELECT * FROM security_tbl WHERE isactive != 2";
//echo $qry;
                                                        ...
                                                        while($row=mysqli_fetch_assoc($rs))
                                                        {
                                                            ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="edit_security.php?id=<?php echo $row['id']; ?>" class="btn">Edit</a>
                                                                        <a href="delete_security.php?id=<?php echo $row['id']; ?>" class="btn">Delete</a>
                                                                    </td>
