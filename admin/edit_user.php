...
echo $_GET['id'];
require 'connect.php';
$qry="SELECT * FROM user1 WHERE isactive != 2 AND id='".$_GET['id']."'";
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        <form action="user_process_update.php" method="post">
                                        	<input type='hidden' name="id" value="<?php echo $row['id'] ?>">
                                        <table class="table">
                                            <tbody>
                                                 <tr>
                                                    <td class="col-md-4">First Name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Firstname" class="form-control" name="firstname" value="<?php echo $row['firstname'] ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Last Name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Last Name:" class="form-control" name="lastname" value="<?php echo $row['lastname'] ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Email:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Email:" class="form-control" name="email" value="<?php echo $row['email'] ?>"></td>
                                                </tr>
                                               <!--  <tr>
                                                    <td class="col-md-4">Gender</td>
                                                    <td class="col-md-8"><input type="radio" name="gender" value="male"> Male
                                                        <input type="radio" name="gender" value="female"> Female</td>
                                                </tr>
                                                --> <tr>
                                                    <td class="col-md-4">Password:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Password" class="form-control" name="password" value="<?php echo $row['password'] ?>"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Comfirm Password:</td>
                                                    <td class="col-md-8"><input type="password" placeholder="Password" class="form-control" name="cpassword" value=""></td>
                                                </tr>
                                                    <td class="col-md-4">
