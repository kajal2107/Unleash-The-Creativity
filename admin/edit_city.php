...
echo $_GET['id'];
require 'connect.php';
$qry="SELECT * FROM city_tbl WHERE isactive != 2 AND id='".$_GET['id']."'";
                        ...
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        <form action="city_process_update.php" method="post">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-md-8">
                                                        <?php 
                                                        require 'connect.php';
                                                        $q = "SELECT * FROM state_tbl WHERE isactive=1";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="City" class="form-control" name="city"></td>
                                                </tr>
                                                    <td class="col-md-4">
                                                        <button type="submit" class="btn btn-success" name="submit"> Add city</button></td>
                                                    <td class="col-md-8">
