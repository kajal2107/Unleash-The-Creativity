                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Add Prouct</h2>
                                </header>
                                <div class="contents">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="Product name" class="form-control" name="name"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Product Description:</td>
                                                    <td class="col-md-8"><input type="area" placeholder="Product Description" class="form-control" name="description"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">ProductFull  Description:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Product Full Description" class="form-control" name="fulldescription"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Product Price:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Price" class="form-control" name="price"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Product Image:</td>
                                                    <td class="col-md-8"><input type="file" name="fileToUpload" ><br></td>
                                                </tr>
                                                ...
                                                --> 
                                                    <td class="col-md-4">
                                                        <button class="btn btn-success" name="submit"> Add Product</button></td>
                                                    <td class="col-md-8">
