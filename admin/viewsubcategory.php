  <?php
require 'connect.php';
$qry="SELECT * FROM sub_cat_tbl WHERE isactive != 2";
//echo $qry;
    ...
    <div class="structure-row">
       ...
       <aside class="sidebar">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">view Sub category</h2>
                                </header>
                                <div class="contents">
        ...
        <tr>
            ...
            <td>
                <?php $q = "SELECT * FROM category_tbl WHERE id='".$row['category_id']."'";
            ...
            <td>
                     <a href="edit_subcategory.php?id=<?php echo $row['id']; ?>" class="btn">Edit</a>
                     </td>
                     <td>       
                      <a href="delete_subcategory.php?id=<?php echo $row['id']; ?>" class="btn">Delete</a>
                                                                    </td>
                                      </tr>                          
        <?php
    }
