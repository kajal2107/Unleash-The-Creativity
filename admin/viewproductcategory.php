  <?php
require 'connect.php';
$qry="SELECT * FROM product_cat_tbl WHERE isactive != 2";
//echo $qry;
    ...
    <div class="structure-row">
       ...
       <aside class="sidebar">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">View Product category</h2>
                                </header>
                                <div class="contents">
        ...
        <tr>
            ...
            <td>
                     <a href="edit_productcategory.php?id=<?php echo $row['id']; ?>" class="btn">Edit</a>
                     </td>
                     <td>       
                      <a href="delete_productcategory.php?id=<?php echo $row['id']; ?>" class="btn">Delete</a>
                                                                    </td>
